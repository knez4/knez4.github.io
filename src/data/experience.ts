...
export const experience: Role[] = [
  {
    ...
    points: {
      ...
      en: [
        ...
        'Built a Python tool that turns nine client Excel workbooks into nine finished PDF reports in three seconds, replacing a step done by hand every month.',
      ...
      sr: [
        ...
        'Napravio sam Python alat koji devet klijentskih Excel svezaka pretvara u devet gotovih PDF izveštaja za tri sekunde, umesto ručnog mesečnog koraka.',
