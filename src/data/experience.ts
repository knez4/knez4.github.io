...
/**
 * Reverse-chronological by end date, most current first: the freelance role is
 * still ongoing ("present"), so it leads; within FD Organization, DigiCon
 * (ends May 2025) comes before Future Leader (ends 2024) even though Future
 * Leader started later, because it also ended later.
 *
